...
const AudienceStepForm: React.FC<RefinementStepFormProps> = ({ step, userInput, setUserInput, handleNextStep, isGenerating, isLastStep }) => {
...
export default AudienceStepForm;