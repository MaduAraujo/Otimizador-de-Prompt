...
const ConstraintsStepForm: React.FC<RefinementStepFormProps> = ({ step, userInput, setUserInput, handleNextStep, isGenerating, isLastStep }) => {
    const isInputEmpty = !userInput.trim();
    
    const getButtonText = () => {
        if (isGenerating) return 'Aplicando...';
...
export default ConstraintsStepForm;